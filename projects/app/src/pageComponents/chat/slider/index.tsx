...
const LogoSection = () => {
  ...
  const wideLogoSrc = logos.wideLogoUrl || DEFAULT_LOGO_BANNER_URL;
  const squareLogoSrc = logos.squareLogoUrl || DEFAULT_LOGO_BANNER_COLLAPSED_URL;
